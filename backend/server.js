...
app.get('/resolved-artworks/Karlstad', async (req, res) => {
  const resolvedArtworks = await resolvedArtWorkKarlstad.find().populate("artwork").populate("user")
  res.json(resolvedArtworks)
})

app.get('/resolved-artworks/Uppsala', async (req, res) => {
  const resolvedArtworks = await resolvedArtWorkUppsala.find().populate("artwork").populate("user")
  res.json(resolvedArtworks)
})
